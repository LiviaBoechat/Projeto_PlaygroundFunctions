        ...
        for (let index = 0; index < numeros.length; index++) {
          for (let i2 = 0; i2 < numeros.length; i2++) {
            if (numeros[index] == numeros[i2]) {
              ...
              let primParte = '';
              let segParte = '';
              for (let index = 0; index < numeros.length -9; index++) {
                ddd += numeros[index];
              }
              for (let index = 2; index < numeros.length -4; index++) {
                primParte += numeros[index];
              }
              for (let index = 7; index < numeros.length; index++) {
                segParte += numeros[index];
              }              
              return `(${ddd}) ${primParte}-${segParte}`;
            }            
          }
        }
      } 
